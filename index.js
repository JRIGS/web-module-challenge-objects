...
const burgerDiscount = (customer) => {
  ...
  return `You've recieved $${burger.price * discountPercentage} off your burger!`;
}
...
reviews.push({name: "Jon", rating: 5, feedback: "Spaggett was good"})
